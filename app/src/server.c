...
bool sc_server_init(struct sc_server *server, const struct sc_server_params *params,
                 ...
                 struct sc_server_info *info)
{
    ...
    info->frame_size.width = (buf[SC_DEVICE_NAME_FIELD_LENGTH] << 8) | buf[SC_DEVICE_NAME_FIELD_LENGTH + 1];
    info->frame_size.height = (buf[SC_DEVICE_NAME_FIELD_LENGTH + 2] << 8) | buf[SC_DEVICE_NAME_FIELD_LENGTH + 3];
    return true;
}
